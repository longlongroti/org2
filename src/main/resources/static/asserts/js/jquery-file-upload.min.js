...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        this.createProgress = function (filename,filepath,filesize,fileUuid) {
        ...
        function defaultProgressBar(obj,s)
        {
            ...
            this.abort = $("<div style='color:red'>" + s.abortStr + "</div>").appendTo(this.statusbar).hide();
            this.cancel = $("<div'><a class='btn'>" + s.cancelStr + "</a></div>").appendTo(this.statusbar).hide();
            this.done = $("<div style='color:blue'>" + s.doneStr + "</div>").appendTo(this.statusbar).hide();
            this.download = $("<div>" + s.downloadStr + "</div>").appendTo(this.statusbar).hide();
            this.del = $("<div><a class='btn btn-danger'>" + s.deleteStr + "</a></div>").appendTo(this.statusbar).hide();
